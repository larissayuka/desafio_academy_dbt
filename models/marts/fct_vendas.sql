with
    ...
    , int_vendas_pedidos_detalhes as (
        select *
    ...
    , joined_tabelas as (
        select *
        from int_vendas_pedidos_detalhes
        left join produtos on
        int_vendas_pedidos_detalhes.id_produto_detalhe = produtos.id_produto
        left join motivos on
        int_vendas_pedidos_detalhes.id_venda_pedido = motivos.id_venda_pedido_chave
        left join enderecos on
        int_vendas_pedidos_detalhes.id_territorio_pedido = enderecos.id_territorio
        left join clientes on
        int_vendas_pedidos_detalhes.id_cliente_pedido = clientes.id_cliente
    )
